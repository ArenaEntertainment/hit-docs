...
- **Share pricing** – Each share trades between \$0.00 and \$1.00, and each pair of shares ("HIT" and "MISS") is fully collaterized by \$1.00 USDC.
...
- **Buy MISS** when you think an event is less likely than the current price indicates.
...
**Example:** You buy 100 HIT shares on "Yankees to beat the Mets" at \$0.52 per share (\$52 total). In the first inning, the Yankees score 4 runs and the price jumps to \$0.72. You sell your position immediately for \$72, locking in a \$20 profit without waiting for the game to finish.
