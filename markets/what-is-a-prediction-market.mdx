...
Every market on Hit has two outcomes:

- **HIT** – The event happens. Equivalent to "Yes" on other prediction markets.
- **MISS** – The event does not happen. Equivalent to "No" on other prediction markets.

When a market resolves, HIT shares pay out \$1.00 if the event occurred, and MISS shares pay out \$1.00 if it did not.
